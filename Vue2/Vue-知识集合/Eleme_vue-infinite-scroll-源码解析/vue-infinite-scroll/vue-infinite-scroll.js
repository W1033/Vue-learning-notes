(function (global, factory) {
  ...
  var getScrollTop = function getScrollTop(element) {
    if (element === window) {
      // - 只读属性 pageYOffset 是 scrollY 的别名. scrollY:
      //   返回文档在垂直方向已滚动的像素值。
      // - document.documentElement.scrollTop: 返回 html 元素的 scrollTop
      return Math.max(
  ...
  // - 取得滑动事件对象 (get scroll event target)
